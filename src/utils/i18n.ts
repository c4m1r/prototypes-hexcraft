...
export interface Translations {
  ...
  worldSetup: {
    ...
    renderingModePrototypeDesc: string;
    renderingModeModernDesc: string;
    worldSeed: string;
...
const translations: Record<Language, Translations> = {
  ru: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: 'Простой рендеринг с цветами блоков',
      renderingModeModernDesc: 'Современный рендеринг с текстурным атласом',
      worldSeed: 'Seed мира',
  ...
  en: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: 'Simple rendering with block colors',
      renderingModeModernDesc: 'Modern rendering with texture atlas',
  ...
  es: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: 'Renderizado simple con colores de bloques',
      renderingModeModernDesc: 'Renderizado moderno con atlas de texturas',
  ...
  de: {
    ...
    worldSetup: {
      ...
      renderingModeModern: 'Modern (Atlas)',
      renderingModePrototypeDesc: 'Einfaches Rendering mit Blockfarben',
      renderingModeModernDesc: 'Modernes Rendering mit Texturatlas',
      worldSeed: 'Welt-Seed',
  ...
  zh: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: '使用方块颜色的简单渲染',
      renderingModeModernDesc: '使用纹理图集的现代渲染',
      worldSeed: '世界种子',
  ...
  ko: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: '블록 색상을 사용한 간단한 렌더링',
      renderingModeModernDesc: '텍스처 아틀라스를 사용한 현대적인 렌더링',
      worldSeed: '월드 시드',
  ...
  ja: {
    ...
    worldSetup: {
      ...
      renderingModePrototypeDesc: 'ブロックカラーを使用したシンプルなレンダリング',
      renderingModeModernDesc: 'テクスチャアトラスを使用したモダンレンダリング',
      worldSeed: 'ワールドシード',
